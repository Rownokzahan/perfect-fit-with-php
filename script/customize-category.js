...
function displayData(){
    $.ajax({
        url:"../php/customize-category/display-data.php",
        type:"post",
...
$("#category-form").on('submit', (function (e) {
    ...
    $.ajax({
        url: "../php/customize-category/create.php",
        type: "POST",
...
function deleteUser(id){
    $.ajax({
        url:"../php/customize-category/delete.php",
        type:'post',
        data:{
            id:id
        },
...
function showDetails(id){
    $('#hidden').val(id);
    $.ajax({
        url:"../php/customize-category/get-details.php",
        type:"post",
        data:{
            id:id,
        },
...
$("#update-category-form").on('submit', (function (e) {
    e.preventDefault(); // preventing form from refreshing
    $.ajax({
        url: "../php/customize-category/update.php",
        type: "POST",
        data: new FormData(this),// using FromData class to send all data of from
        contentType: false,
        cache: false,
